...
class TestContentCalendar(unittest.TestCase):
    ...
    @patch("modules.content_calendar.get_gemini_key", return_value="fake-key")
    ...
    @patch("modules.content_calendar.get_gemini_key", return_value="fake-key")
    @patch("modules.content_calendar.genai")
    def test_entry_count_matches_schedule(self, mock_genai, _mock_key):
    ...
    @patch("modules.content_calendar.get_gemini_key", return_value="fake-key")
    @patch("modules.content_calendar.genai")
    def test_saves_json_and_csv(self, mock_genai, _mock_key):
